        ...
        <div className="about-box">
          <ul className="about-doc">
            ...
            <li>
              ...
              presión, tengo varios años de experencia en atención al cliente y
              asesoramiento tecnologico. Me considero una persona resolutiva,
              productiva, con buen animo y capaz de resolver problemas
              facilmente.
            </li>
          </ul>
          <div>
